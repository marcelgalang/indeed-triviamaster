...
> Thank you for the opportunity for me to showcase my coding. I would like to share about my process for this challenge.

> My initial focus was on fulfilling the requirements of the task as outlined on the README. Typescript, React, CSS in JS (Styled Components) and Redux were implemented. I also used the challenge as an opportunity to use Redux toolkit library and compare the pros and cons over Redux.

> Design considerations were focused on the provided figma files. This is inline with the real world ask of a UX Developer. Styles were matched when provided and ‘look and feel’ were extended. Accessibility was considered with the “radio” buttons.

> Thanks- Marcel Galang
